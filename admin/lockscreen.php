<?php
if (isset($_COOKIE["adminpanelun"]))
{
    include "../dbinfo.php";
    $cn=mysqli_connect(Host,UN,PW,DBname);

    $un = $_COOKIE["adminpanelun"];
...
<div class="lockscreen-wrapper">
    <div class="lockscreen-logo">
        <a href="index2.html"> لوحه<b> المدير</b>
    </div>
    <!-- User name -->
    ...
    <div class="help-block text-center">
        اكتب كلمه المرور للرجوع لصفحه المدير
    </div>
    <div class="text-center">
        <a href="process/anotheraccount.php">او اضغط هنا للدخول بحساب اخر</a>
    </div>
