                ...
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">فئه المنتج </th>
                            <th>&nbsp;</th>
                            <th>&nbsp;</th>
                        </tr>
                        </thead>
                        ...
                        while($arr1=mysqli_fetch_array($rslt1))
                        {
                            ...
                            <tr>
                                ...
                                <td><?php echo "<i class=\"fa fa-edit\"></i> <a href='process/accept.php?cnm=$cnm'>قبول</a>"; ?></td>
                                <td><?php echo "<i class=\"fa fa-remove\"></i> <a href='process/decline.php?cnm=$cnm'>رفض</a>"; ?></td>
                            </tr>
                        <?php }?>
                        </tfoot>
                    </table>
