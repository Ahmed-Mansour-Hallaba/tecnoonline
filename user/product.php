    ...
    <div class="container">
        <div class="col-md-9 single_top">
            <div class="single_left">
                <div class="labout span_1_of_a1">
                    <div class="flexslider">
                        <ul class="slides">
                              ...
                              $rslt=mysqli_query($cn1,"select img from product_images where product_id='$pid'");
                ...
                <?php $rslt1=mysqli_query($cn,"call view_product('$pid')");
...
'; ?>
                ...
                <div  dir="rtl">
                    ...
                    <ul class="tab_list">
                        ...
                        $rslt2=mysqli_query($cn2,"call view_productrating('$pid')");
